...
var Carousel = React.createClass({
  ...
  renderPageIndicator() {
        ...
        for (var i=1; i<= this.props.children.length; i++) {
            style = i === this.state.currentPage ? { color: this.props.indicatorColor,opacity : 1 } : { color: this.props.inactiveIndicatorColor,opacity : 0.3 };
  ...
  render() {
    ...
    contents = (
      ...
      return (
        <View {...containerProps}>
          {contents}
          {this.props.pageInfo && this.renderPageIndicator()}
        </View>
      );
  },
});
